...
export const NAVLINKS = {
  stopOut: [
    { id: 233, title: "Home", description: "Home", state: 1, path: "/main" },
    {
      id: 234,
      title: "Manage Roles",
    ...
    {
      id: 237,
      title: "Edit role main",
      description: "Edit role main",
      state: 0,
      path: "/edit-role-main",
    },
    {
      ...
      description: "Edit role config",
      state: 0,
      path: "/edit-role-config",
    },
    {
      id: 239,
      title: "Edit role groups",
      description: "Edit role groups",
      state: 0,
      path: "/edit-role-groups",
    },
    {
      id: 240,
      title: "Edit role Accounts Exceptions",
      description: "Edit role Accounts Exceptions",
      state: 0,
      path: "/edit-role-accounts-exceptions",
    },
    {
      id: 241,
      title: "Edit role Accounts Separate Definition",
      description: "Edit role AccountsSeparate Definition",
      state: 0,
      path: "/edit-role-accountsseparate-definition",
    },
    {
      id: 242,
      title: "Get role",
    ...
    {
      id: 243,
      title: "Insert role config",
      description: "Edit role config",
      state: 0,
      path: "/insert-role-config",
    },
  ],
  prop: [
    {
